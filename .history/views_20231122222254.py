...
class View:
  ...
  def listar_horarios():
    ...
    for agenda in View.agenda_listar():
        if hoje.date() <= agenda.get_data().date() <= uma_semana.date() and agenda.get_confirmado() == False and agenda.get_id_cliente == agenda.get_id_servico == '0' or agenda.get_id_cliente == agenda.get_id_servico == '0':
